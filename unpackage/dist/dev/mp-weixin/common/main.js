...

{
  ...
  (0, _vuex.mapMutations)(['login', 'logindata', 'logout', 'setplatform', 'setuuid']), {
    dandian: function dandian() {
      var that = this;
      ...
      console.log('请求url：' + _service.default.IPurl + jkurl);
      console.log('请求参数：' + that.loginDatas.token);
      uni.request({
        url: _service.default.IPurl + jkurl,
        data: datas,
        method: 'POST',
        header: _service.default.header,
    ...
    dblogin: function dblogin(e_uuid) {
      var that = this;
