<template>
	<div class="content_wrap" :style="style0">
		...
		<view style="height: 100%;overflow-y: scroll;width: 750upx;">
			...
			<van-swipe-cell v-if="pltype==1" id="swipe-cell" right-width=" 200 " :disabled="false" :async-close="true" @close="onClose" v-for="(item,index) in datas">
				<van-cell-group>
					<view class="data_li">
						<view class="li_msg" @tap="jump"  :data-url="'../details/details?id='+item.id">
							<view class="li_tit">
